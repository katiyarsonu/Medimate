...
{/* 
      ...
      <div className='flex items-conter gap-9 mt-9'>
        {socialLinks.map((link,index)=><Link to={link.path} key={index} className='w-99 h-9 border-solid border-[#18141E] rounded-full flex items-center justify-center group hover:bg-primaryColor hover:border-none '>{link.icon}</Link>)}
...
<p className='text-[15px leading-7 font-[400] text-textColor mt-4]  text__para text-center'>
        Copyright @ {year} developed with ❤ by medimate all rights reserved.
      </p>
